...
(function () {
    ...
    Markdown.Editor = function (markdownConverter, element, help, jQuery) {
        ...
        this.run = function () {
            ...
            uiManager = new UIManager(element, panels, undoManager, previewManager, commandManager, help);
            uiManager.setUndoRedoButtonStates();
    ...
    function UIManager(element, panels, undoManager, previewManager, commandManager, helpOptions) {
